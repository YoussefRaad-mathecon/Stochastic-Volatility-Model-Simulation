...
class HestonModel:
    def __init__(self, S0, v0, r, kappa, theta, sigma, rho, lambda_, gamma1, gamma2, alpha):
        ...
        Attributes:
            ...
            r_grid (np.ndarray): Grid of r values computed using find_rr method.
            f_mu_grid (np.ndarray): Grid of f_mu values.
            f_sigma_grid (np.ndarray): Grid of f_sigma values.
        """
